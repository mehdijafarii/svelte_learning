...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 23, 2, 441);
    			attr_dev(input0, "type", "text");
    			add_location(input0, file, 24, 2, 482);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file, 25, 2, 529);
    			attr_dev(input2, "type", "text");
    			add_location(input2, file, 26, 2, 575);
    			attr_dev(main, "class", "svelte-1vlmv8z");
    			add_location(main, file, 22, 0, 432);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*fullName*/ 8) set_data_dev(t0, /*fullName*/ ctx[3]);
    			if (dirty & /*beltColor*/ 4) set_data_dev(t2, /*beltColor*/ ctx[2]);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const changeColor = () => {
    		$$invalidate(2, beltColor = "Black");
    	};

    	const textChangeColor = e => {
    		$$invalidate(2, beltColor = e.target.value);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*firstName, lastName*/ 3) {
    			// reactive value in svelte
    			$$invalidate(3, fullName = `${firstName} ${lastName}`);
    		}

    		if ($$self.$$.dirty & /*beltColor, fullName*/ 12) {
    			//reactive state (recusive code if any value changes)
    			{
